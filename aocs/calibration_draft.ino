...
void setup() {
  Wire.begin();
  Serial.begin(9600);   //both sensors want 115200 here 
  //ldr set up
...
void loop() {
  ...
  // check to see what one is higher 
  //ldr_values = {ldr1Value, ldr2Value, ldr3Value, ldr4Value};
  Serial.println("LDR 1 value is :");//Prints the value of LDR to Serial Monitor.
  Serial.println(ldr1Value);
  Serial.println("LDR 2 value is :");//Prints the value of LDR to Serial Monitor.
  Serial.println(ldr2Value);
  Serial.println("LDR 3 value is :");//Prints the value of LDR to Serial Monitor.
  Serial.println(ldr3Value);
  Serial.println("LDR  4 value is :");//Prints the value of LDR to Serial Monitor.
  Serial.println(ldr4Value);
  if(ldr3Value<400)         //dark
    {
